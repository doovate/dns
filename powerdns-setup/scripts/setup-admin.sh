...
install_reqs() {
  ...
  apt-get update -y
  apt-get install -y git python3-venv python3-pip python3-dev python3-distutils build-essential libpq-dev pkg-config libmariadb-dev libffi-dev libldap2-dev libsasl2-dev libssl-dev
}
